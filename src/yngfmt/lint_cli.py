...
def build_parser() -> ArgumentParser:
    ...
    parser.add_argument("--pyproject", type=Path, help="Explicit pyproject.toml path for project checker settings.")
    return parser
...
def main() -> int:
    ...
    files: list[Path] = list(iter_python_files(paths=arguments.paths))
