...
path = Path("docs/python-style-guide.ko.md")
...
call_section = '''### 4.8.1 Function Call Formatting
...
'''
text = re.sub(
    r"### 4\.8\.1 Function Call Formatting\n.*?\n---\n\n## 5\.",
    call_section + "---\n\n## 5.",
    text,
    flags=re.DOTALL,
)
text = text.replace(
    "## 6. Result Object Convention\n\nResult object는 dictionary 기반으로도 사용할 수 있지만,",
...
automation = '''## 12. Automation Mapping
